...
private:
	...
	forward_list<unsigned int> recycledCellIDs;
	forward_list<unsigned int> recycledFaceIDs;
...
public:
	...
	void init_mapFaceToCell(unsigned int cellID, unsigned int faceID, DIR d) {
